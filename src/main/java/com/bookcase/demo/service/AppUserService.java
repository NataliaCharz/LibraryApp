...
public class AppUserService {
    ...
    public void deleteUserBook(Long userId, Long bookId) {
        ...
        appUser.getUserBooks().removeIf(book -> book.getBookId().equals(bookId));
    ...
    public void deleteUserFavoriteBook(Long userId, Long bookId) {
        AppUser appUser = userRepository.findAppUserByUserId(userId)
                .orElseThrow(() -> new IllegalArgumentException("User with id " + userId + " not found"));
        appUser.getFavoriteBooks().removeIf(book -> book.getBookId().equals(bookId));
        userRepository.save(appUser);
    }
    ...
    public void deleteUserWishListBook(Long userId, Long bookId) {
        AppUser appUser = userRepository.findAppUserByUserId(userId)
                .orElseThrow(() -> new IllegalArgumentException("User with id " + userId + " not found"));
        appUser.getWishlistBooks().removeIf(book -> book.getBookId().equals(bookId));
        userRepository.save(appUser);
    }
